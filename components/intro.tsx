...
import { FaGithub, FaGithubSquare, FaTwitter } from "react-icons/fa";
    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://imageupload.io/ib/ZR8O7AzdQG3f8YI_1693594231.png"
              alt="Manish portrait"
              width="200"
              height="200"
              quality="100"
              priority={true}
              className="h-38 w-38 rounded-full object-cover border-[0.30rem] border-white shadow-xl"
            />
          </motion.div>
      ...
      >
        <span className="font-bold">Hello, I'm Manish Tiwari.<br></br></span> I'm a{" "}
